export default {
  ...
  header: {
    title:
      "API Endpoint Round-Robin Proxy, Auto-switch to Available Endpoints for Seamless Failover",
    port: "Port",
  ...
  endpoints: {
    ...
    testTipFailed:
      "Connection test failed or endpoint does not support API testing",
    ...
    dragDisabledDuringFilter:
      "Cannot drag in filter mode. Clear filters first.",
  ...
  modal: {
    ...
    tokenPoolApiUrlHelp:
      "Token Pool only handles authentication; API URL and transformer behavior stay as configured on the endpoint",
    codexTokenPoolApiUrlHelp:
      "Codex Token Pool uses fixed upstream https://chatgpt.com/backend-api/codex and fixed transformer OpenAI2 (Responses API)",
    ...
    transformer: "Transformer",
    transformerHelp:
      "Select the API format, auto will select based on relay solution and model",
    transformerOptionAuto: "Auto (Recommended)",
    transformerOptionPassthrough: "Passthrough",
    ...
    providerType: "Relay Solution",
    providerTypeHelp: "Select the relay solution type, native means native API",
    providerTypeNative: "Native",
    providerTypeOneAPI: "OneAPI",
    providerTypeNewAPI: "NewAPI",
    providerTypeSub2API: "Sub2API",
    providerTypeCliproxyAPI: "CliproxyAPI",
    customPath: "Custom Path",
    customPathPlaceholder: "e.g., /v1/chat/completions",
    customPathHelp:
      "Optional: Custom API path that overrides the auto-selected path",
    cancel: "Cancel",
    save: "Save",
    ...
    portUpdateSuccess:
      "Port updated successfully! Please restart the application for changes to take effect.",
    ...
    fetchModelsUsingTokenPool:
      "Token Pool mode will use an available credential to fetch models",
    tokenPoolOnlyForTokenMode:
      "Token pool can only be managed in Token Pool mode",
  ...
  test: {
    ...
    notSupportedMessage:
      "This endpoint not support test API, try using it directly in the client",
  },
  welcome: {
  ...
  settings: {
    ...
    themeAuto: "Auto Mode",
    themeAutoHelp:
      "Auto Mode: Automatically switch between light and dark themes based on time (7:00-19:00 uses light theme)",
    autoThemeConfigTitle: "Configure Auto Theme",
    autoThemeConfigDesc:
      "Please select the light and dark themes to use in auto mode",
    ...
    closeWindowBehaviorHelp:
      "Choose the default action when clicking the close button",
    closeWindowOptions: {
      quit: "Quit Directly",
    ...
    notificationHelp:
      "Send notification when Claude Code task completes (Note: Restart terminal to take effect)",
  ...
  history: {
    ...
    confirmDelete:
      "Are you sure you want to delete the historical data for {month}? This action cannot be undone",
  ...
  webdav: {
    ...
    connectionSuccess: "Connection successful",
    connectionFailed: "Connection failed",
    connectionFailedWithRecommend:
      "Connection failed, recommend using Nutstore WebDAV service",
    ...
    useRemoteDesc:
      "Remote configuration will overwrite local conflicting endpoints",
    keepLocalDesc:
      "Keep local configuration, only add new endpoints from remote",
    // Error messages
    errors: {
  ...
  backup: {
    ...
    errors: {
      ...
      backup_s3_endpoint_invalid:
        "Invalid S3 endpoint (use host:port or https://host:port)",
      backup_s3_endpoint_path_not_supported:
        "S3 endpoint must not contain path, please put it into Prefix",
  ...
  update: {
    ...
    install_instructions_windows:
      "1. Close current ccg application<br>2. Run the new ccg.exe",
    install_instructions_macos:
      "1. Close current ccg application<br>2. Drag the new ccg.app to Applications folder",
    install_instructions_linux:
      "1. Close current ccg application<br>2. Run the new ccg executable",
    ...
    install_ready_windows:
      "Click Update Now button to complete the update automatically",
  },
  terminal: {
    title: "Launcher",
    ...
    projectDirsHelp:
      "Add frequently used project directories for quick terminal launch",
    ...
    noMatchingEndpoints:
      "No matching endpoints found (ensure endpoints with corresponding transformer are enabled)",
    configError: "Config Error",
    applySuccess: "Config applied successfully",
  ...
  session: {
    ...
    selectHint:
      "Click a session to select, then return to launcher to start the terminal with the session",
